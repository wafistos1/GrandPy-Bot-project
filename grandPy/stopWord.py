""" Module that groups a list of stopwords and a list of keywords
"""
...
DIC_STOPWORDS = [
    ...
    "ça", "ès",
    "étaient", "étais", "était", "étant", "été", "être", "ô", "?", "le", "de", 'li', 'Salut', '!',
    'Est-ce',
    'la', 'de', 'l', 'le', 'du'
    ]
...
KEY_WORDS = [
    'emplacement', 'localité', 'place', 'adresse', 'endroit', 'lieu', 'trouve'
    ]
